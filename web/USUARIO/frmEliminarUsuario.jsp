...
<html>
    ...
    <body class="container w-50 h-100">
        <form action="frmEliminarUsuario.jsp" class="w-100">
            <%
        ...
        <button type="submit" class="btn btn-danger btn-block mb-2" name="btnEliminar" id="btnEliminar">Eliminar</button>
        </form>
