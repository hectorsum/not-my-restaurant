...
<html>
    ...
    <body class="container w-auto h-100">
        <form action="frmRegistrarEmpleado.jsp" method="POST" class="w-100">
            <%
        ...
        <button type="submit" class="btn btn-success btn-block mb-2" name="btnRegistrar">Registrar</button>
        </form>
        ...
        <%
            if(request.getParameter("btnRegistrar")!=null){
                temp = new empleado(request.getParameter("nom_cli"), 
