...
<html>
    ...
    <body class="container w-50">
        <form action="frmRegistrarProducto.jsp" method="POST" class="w-100">
            <%
            producto temp = new producto();
            L_Producto con = new L_Producto();
        %>
        <label for="nombre">Nombre</label>
        <input type="text" class="form-control mb-2" name="nombre" id="nombre" autocomplete="off">
        ...
        <button type="submit" class="btn btn-success btn-block mb-1" name="btnRegistrar">Registrar</button>
        </form>
        ...
        <%
            if(request.getParameter("btnRegistrar")!=null){
                temp = new producto(request.getParameter("nombre"), 
                                    request.getParameter("precio"),
                                    request.getParameter("categoria"));
                con.insertarProducto(temp);
            }
        %>
